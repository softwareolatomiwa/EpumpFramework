#
#  Be sure to run `pod spec lint EpumpFramework.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  A longer description than the summary, because that's the rukle for cocoapods
                   DESC

  spec.homepage     = "https://github.com/softwareolatomiwa/EpumpFramework"
  ...
  spec.source       = { :git => "https://github.com/softwareolatomiwa/EpumpFramework.git", :tag => "#{spec.version}" }
